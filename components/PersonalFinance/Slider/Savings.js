...
export function Savings({ balance }) {
  return (
    <div className="border-2 shadow-md h-44 sm:h-64 bg-[#fbfbfb] rounded-2xl border-[#e0eaff] sm:bg-[#F5F7F8] min-w-max">
      <div className="mt-4 mb-2 ml-7 mr-9 sm:mb-5">
        ...
        <div className="flex flex-col m-4 sm:m-6 ">
          <div className="sm:rounded-2xl sm:border-2 sm:border-[#F5F5F5] sm:bg-[#FEFEFE] min-w-max">
