...
export function IncomeExpense({ income, expense }) {
  return (
    <div className="border-2 shadow-md h-44 sm:h-64 bg-[#fbfbfb] rounded-2xl border-[#e0eaff] sm:bg-[#F5F7F8]">
      <div className="mt-2 ml-3 mr-4 sm:mr-10 sm:ml-8 sm:mb-5 sm:mt-5">
        ...
        <div className="flex flex-col m-2 sm:m-6">
          <div className="flex">
            ...
            <div className="flex flex-col w-1/2">
              <div className="flex flex-col items-end pt-2 pb-2 mb-2 sm:rounded-2xl sm:border-2 sm:border-[#F5F5F5] sm:bg-[#FEFEFE]">
                <div className="mr-2">
                  <p className="text-xs font-medium text-right text-blue">Total Income:</p>
                  <span className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#4A56E2] to-[#24CCA7]">{formatCurrency(income || '')}</span>
                </div>
              </div>
              <div className="flex flex-col items-end pt-2 pb-2 sm:rounded-2xl sm:border-2 sm:border-[#F5F5F5] sm:bg-[#FEFEFE]">
                <div className="mr-2">
                  ...
                  <span className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#D96C6C] to-[#4A56E2]">{formatCurrency(expense || '')}</span>
                </div>
              </div>
            </div>
          </div>
